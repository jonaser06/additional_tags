...
if (!function_exists('themerex_sc_selector_add_in_toolbar')) {
	...
	function themerex_sc_selector_add_in_toolbar(){
		...
		$shortcodes_list = '<select class="sc_selector"><option value="">&nbsp;'.__('- Select Shortcode -', 'additional-tags').'&nbsp;</option>';
...
require_once( trx_addons_get_file_dir('shortcodes/googlemap/googlemap.php') );
