...
class themerex_widget_recent_reviews extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_recent_reviews', 'description' => __('Recent reviews', 'additional-tags'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_recent_reviews');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_recent_reviews', __('ThemeREX - Recent reviews', 'additional-tags'), $widget_ops, $control_ops );
