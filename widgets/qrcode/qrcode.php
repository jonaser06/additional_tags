...
class themerex_widget_qrcode extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_qrcode', 'description' => __('Generate QRCode with your personal data or with any text (links)', 'additional-tags'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'themerex_widget_qrcode');

		/* Create the widget. */
		parent::__construct( 'themerex_widget_qrcode', __('ThemeREX - QRCode generator', 'additional-tags'), $widget_ops, $control_ops );
	...
	function widget($args, $instance) {
		...
		if ($show_personal) 
			$output .= '
					...
					' . ($show_what==1 
						? '<p class="user_name odd first"><span class="theme_text">' . __('Name:', 'additional-tags') . '</span> <span class="theme_info">' . ($ufname) . ' ' . ($ulname) . '<span></p>'
							. ($ucompany ? '<p class="user_company even"><span class="theme_text">' . __('Company:', 'additional-tags') . '</span> <span class="theme_info">' . ($ucompany) . '<span></p>' : '')
							. ($uphone ? '<p class="user_phone odd"><span class="theme_text">' . __('Phone:', 'additional-tags') . '</span> <span class="theme_info">' . ($uphone) . '<span></p>' : '')
							. ($uemail ? '<p class="user_email even"><span class="theme_text">' . __('E-mail:', 'additional-tags') . '</span> <a href="' . esc_url('mailto:'.($uemail)) . '">' . ($uemail) . '</a></p>' : '')
							. ($usite ? '<p class="user_site odd"><span class="theme_text">' . __('Site:', 'additional-tags') . '</span> <a href="' . esc_url($usite) . '" target="_blank">' . ($usite) . '</a></p>' : '')
						: $text)
						. '
					</div>
					';
	...
	function form($instance) {
		...
		$defaults = array(
			'title' => '', 
			'description' => __('QR Code Generator (for your vcard)', 'additional-tags'),
			'ulname' => '', 
			'ufname' => '', 
			'ucompany' => '', 
			'uaddr' => '', 
		...
		<div class="widget_qrcode">
        	<div class="qrcode_tabs">
                <ul class="tabs">
                    <li class="first"><a href="#tab_settings"><?php _e('Settings', 'additional-tags'); ?></a></li>
                    <li><a href="#tab_fields" onmousedown="themerex_qrcode_init()"><?php _e('Personal Data', 'additional-tags'); ?></a></li>
                    <li><a href="#tab_text" onmousedown="themerex_qrcode_init()"><?php _e('Any Text', 'additional-tags'); ?></a></li>
                </ul>
                <div id="tab_settings" class="tab_content tab_settings">
                    ...
                    <p>
                        <label><?php _e('Show as QR Code:', 'additional-tags'); ?></label><br />
                        ...
                        <label for="<?php echo esc_attr($this->get_field_id('show_what')); ?>_1"> <?php _e('Personal VCard', 'additional-tags'); ?></label>
                        ...
                        <label for="<?php echo esc_attr($this->get_field_id('show_what')); ?>_0"> <?php _e('Any text', 'additional-tags'); ?></label>
                    </p>
                    <p>
                        ...
                        <label for="<?php echo esc_attr($this->get_field_id('show_personal')); ?>"><?php _e('Show data under QR Code:', 'additional-tags'); ?></label>
                    </p>
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('width')); ?>"><?php _e('Width:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('color')); ?>"><?php _e('Color:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('bg')); ?>"><?php _e('Bg color:', 'additional-tags'); ?></label>
                ...
                <div id="tab_fields" class="tab_content tab_personal">
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('ulname')); ?>"><?php _e('Last name:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('ufname')); ?>"><?php _e('First name:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('ucompany')); ?>"><?php _e('Company:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('uphone')); ?>"><?php _e('Phone:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('uaddr')); ?>"><?php _e('Address:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('ucity')); ?>"><?php _e('City:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('upostcode')); ?>"><?php _e('Post code:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('ucountry')); ?>"><?php _e('Country:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('uemail')); ?>"><?php _e('E-mail:', 'additional-tags'); ?></label>
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('usite')); ?>"><?php _e('Web Site URL:', 'additional-tags'); ?></label>
                ...
                <div id="tab_text" class="tab_content tab_text">
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id('fld_text')); ?>"><?php _e('Text to show as QR Code:', 'additional-tags'); ?></label>
            ...
            <p>
                <input class="fld_button_draw" id="<?php echo esc_attr($this->get_field_id('button_draw')); ?>" name="<?php echo esc_attr($this->get_field_name('button_draw')); ?>" value="<?php echo esc_attr(__('Update', 'additional-tags')); ?>" type="button" />
                ...
                <label for="<?php echo esc_attr($this->get_field_id('auto_draw')); ?>"> <?php _e('Auto', 'additional-tags'); ?></label>
            </p>
...
<?php if ($instance['show_personal']==1) { ?>
				...
				<?php if ($instance['show_what']==1) { ?>
                    <li class="user_name odd first"><?php echo  __('Name:', 'additional-tags') . ' ' . ($instance['ufname']) . ' ' . ($instance['ulname']); ?></li>
                    <?php 
						echo  ($instance['ucompany'] ? '<li class="user_company even">' . __('Company:', 'additional-tags') . ' ' . ($instance['ucompany']) . '</li>' : '')
							. ($instance['uphone'] ? '<li class="user_phone odd">' . __('Phone:', 'additional-tags') . ' ' . ($instance['uphone']) . '</li>' : '')
							. ($instance['uemail'] ? '<li class="user_email even">' . __('E-mail:', 'additional-tags') . ' ' . '<a href="' . esc_url('mailto:'.($instance['uemail'])) . '">' . ($instance['uemail']) . '</a></li>' : '')
							. ($instance['usite'] ? '<li class="user_site odd">' . __('Site:', 'additional-tags') . ' ' . '<a href="' . esc_url($instance['usite']) . '" target="_blank">' . ($instance['usite']) . '</a></li>' : '');
					?>
				<?php } else { ?>
